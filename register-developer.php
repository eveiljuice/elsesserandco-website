<?php
/**
 * Developer Registration Page - Elsesser & Co.
 * Страница регистрации застройщика
 */

$data = require_once __DIR__ . '/includes/auth/register_developer.php';
$errors = $data['errors'];
...
<head>
    ...
    <meta name="description" content="Регистрация застройщика на платформе Elsesser & Co. — станьте партнёром и получите доступ к инструментам продаж.">
    <title>Регистрация застройщика | Elsesser & Co.</title>
    ...
    <style>
        /* Дополнительные стили для формы застройщика */
        .auth-form--developer {
            max-width: 560px;
        }
        ...
        .form-group--half .form-input-wrapper {
            width: 100%;
            display: flex;
            align-items: center;
        }
        ...
        .file-upload__label:hover {
            border-color: var(--color-accent);
            background-color: rgba(194, 157, 102, 0.05);
        }
        ...
        <div class="container">
            <div class="auth-container">
                <div class="auth-form-wrapper">
                    <div class="auth-form auth-form--developer">
                        <?php if ($success): ?>
                        ...
                        <div class="success-message">
                            ...
                            <p class="success-message__text">
                                Ваша заявка на регистрацию застройщика успешно отправлена на рассмотрение.<br><br>
                                Наши специалисты проверят предоставленную информацию в течение <strong>1-3 рабочих дней</strong>. 
                                После одобрения заявки вы получите на указанный email данные для входа в личный кабинет застройщика.
                            </p>
                        ...
                        <?php else: ?>
                        <!-- Форма регистрации -->
                        <h1 class="auth-form__title">Регистрация застройщика</h1>
                        ...
                        <div class="info-box">
                            ...
                            <p class="info-box__text">
                                Регистрация доступна для застройщиков и девелоперских компаний. 
                        ...
                        <form method="POST" action="register-developer.php" enctype="multipart/form-data" class="form" id="developerRegisterForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input-wrapper">
                                        ...
                                        <input type="text" 
                                               ...
                                               name="company_name" 
                                               class="form-input" 
                                               placeholder="Например: СК Легенда"
                            ...
                            <div class="form-section">
                                ...
                                <!-- Логотип компании -->
                                <div class="form-group">
                                    <label class="form-label">Логотип компании <span class="form-label__optional">(необязательно)</span></label>
                                    <div class="file-upload">
                                        ...
                                        <label for="logo" class="file-upload__label">
                                            <div class="file-upload__icon">
                                                <i class="fas fa-image"></i>
                                            </div>
                                            <div class="file-upload__text">
                                                <div class="file-upload__title">Выберите файл или перетащите сюда</div>
                                                <div class="file-upload__hint">PNG, JPG, GIF, WebP до 5 МБ</div>
                                            </div>
                                        </label>
                                        <div class="file-upload__preview" id="logoPreview">
                                            <i class="fas fa-check-circle" style="color: #16a34a;"></i>
                                            <span class="file-upload__preview-text" id="logoFileName"></span>
                                            <button type="button" class="file-upload__remove" id="logoRemove">
                                ...
                                <div class="form-group form-group--half">
                                    ...
                                    <div>
                                        <label for="completed_projects" class="form-label">Завершённых проектов <span class="form-label__optional">(необязательно)</span></label>
                                        <div class="form-input-wrapper">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   class="form-input" 
                                                   placeholder="5"
                                                   value="<?= htmlspecialchars($formData['completed_projects']) ?>"
                                                   min="0"
                                                   max="1000">
                                        </div>
                                    </div>
                        ...
                        <p class="auth-footer">
                            Уже есть аккаунт застройщика? <a href="login.php">Войдите</a>
                        </p>
                        <?php endif; ?>
                    </div>
                </div>
                
                <div class="auth-image" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1920&q=80');">
                    <div class="auth-image__content">
                        ...
                        <ul class="auth-benefits">
                            ...
                            <li><i class="fas fa-check"></i> Удобный личный кабинет застройщика</li>

<?php
/**
 * Admin - Agency Applications Management
 * Управление заявками на регистрацию агентств
 */
    ...
    if ($applicationId) {
        try {
            if ($action === 'approve') {
                ...
                $stmt = $pdo->prepare("SELECT * FROM agency_applications WHERE id = ? AND status IN ('pending', 'reviewing')");
                ...
                if ($application) {
                    ...
                    $stmt = $pdo->prepare("
                        INSERT INTO users (
                            ...
                            company_name, inn, is_agency, is_active
                        ) VALUES (?, ?, ?, ?, ?, 'agent', ?, ?, 1, 1)
                    ");
                    ...
                    error_log("Agency approved: {$application['company_name']} (ID: {$applicationId}) by admin ID: " . getCurrentUserId());
                } else {
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    $messageType = 'warning';
                    error_log("Agency rejected: ID {$applicationId} by admin ID: " . getCurrentUserId());
                } else {
                    $message = "Заявка не найдена или уже обработана";
                    $messageType = 'error';
                }
            ...
            error_log("Agency action error: " . $e->getMessage());
...
// Получаем заявки
$whereClause = $statusFilter !== 'all' ? "WHERE aa.status = ?" : "";
$params = $statusFilter !== 'all' ? [$statusFilter] : [];

// Общее количество
$countSql = "SELECT COUNT(*) FROM agency_applications aa $whereClause";
...
<head>
    ...
    <style>
        ...
        .agency-card__section:last-child {
            margin-bottom: 0;
        }
        
        .agency-card__section-title {
        ...
        <main class="admin-main">
            <div class="admin-header">
                ...
                <div class="admin-breadcrumb">
                    <a href="index.php"><i class="fas fa-home"></i></a> / Заявки агентств
                </div>
            </div>
            ...
            <?php if (isset($_SESSION['approved_agency'])): ?>
            <div class="credentials-box">
                <div class="credentials-box__title">
                    <i class="fas fa-key"></i> Данные для входа агентства:
                </div>
                <div class="credentials-box__item">
                    <span class="credentials-box__label">Компания:</span>
                    <span class="credentials-box__value"><?= htmlspecialchars($_SESSION['approved_agency']['company_name']) ?></span>
                </div>
                <div class="credentials-box__item">
                    <span class="credentials-box__label">Email:</span>
                    <span class="credentials-box__value"><?= htmlspecialchars($_SESSION['approved_agency']['email']) ?></span>
                </div>
                <div class="credentials-box__item">
                    <span class="credentials-box__label">Пароль:</span>
                    <span class="credentials-box__value"><?= htmlspecialchars($_SESSION['approved_agency']['password']) ?></span>
                </div>
                <p style="font-size: var(--text-sm); color: #065f46; margin-top: var(--space-3);">
                    <i class="fas fa-exclamation-triangle"></i> 
                    Скопируйте эти данные и отправьте агентству. Пароль показывается только один раз!
                </p>
            </div>
            <?php unset($_SESSION['approved_agency']); ?>
            <?php endif; ?>
            ...
            <div class="agency-card">
                ...
                <div class="agency-card__body">
                    <div class="agency-card__grid">
                        <!-- Контакты -->
                        <div class="agency-card__section">
                            <div class="agency-card__section-title">Контактная информация</div>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Контактное лицо:</span>
                                <span class="agency-card__value"><?= htmlspecialchars($app['contact_person']) ?></span>
                            </div>
                            <?php if ($app['contact_position']): ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Должность:</span>
                                <span class="agency-card__value"><?= htmlspecialchars($app['contact_position']) ?></span>
                            </div>
                            <?php endif; ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Email:</span>
                                <span class="agency-card__value">
                                    <a href="mailto:<?= htmlspecialchars($app['email']) ?>"><?= htmlspecialchars($app['email']) ?></a>
                                </span>
                            </div>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Телефон:</span>
                                <span class="agency-card__value">
                            ...
                            <?php if ($app['website']): ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Сайт:</span>
                                <span class="agency-card__value">
                        ...
                        <!-- Адреса -->
                        <div class="agency-card__section">
                            <div class="agency-card__section-title">Адреса</div>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Юридический:</span>
                                <span class="agency-card__value"><?= htmlspecialchars($app['legal_address']) ?></span>
                            </div>
                            <?php if ($app['actual_address']): ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Фактический:</span>
                                <span class="agency-card__value"><?= htmlspecialchars($app['actual_address']) ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <!-- О компании -->
                        <div class="agency-card__section">
                            <div class="agency-card__section-title">О компании</div>
                            <?php if ($app['specialization']): ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Специализация:</span>
                                <span class="agency-card__value">
                            ...
                            <div class="agency-card__row">
                                <span class="agency-card__label">На рынке:</span>
                                <span class="agency-card__value"><?= $app['years_on_market'] ?> лет</span>
                            </div>
                            <?php endif; ?>
                            <?php if ($app['agents_count']): ?>
                            <div class="agency-card__row">
                                <span class="agency-card__label">Агентов:</span>
                                <span class="agency-card__value"><?= $app['agents_count'] ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="agency-card__section" style="margin-top: var(--space-4);">
                        <div class="agency-card__section-title">Описание</div>
